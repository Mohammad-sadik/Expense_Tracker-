...
export const TransactionProvider = ({ children }) => {
    ...
    const addTransaction = async (transaction) => {
        try {
            ...
            // For simplicity, re-fetch or prepend. Prepending is better but might mess up pagination if not careful.
            // Easiest is to prepend and maybe invalidate cache logic.
    ...
    // Removed client-side filtering as logic is now server-side
    // const filteredTransactions = transactions.filter(...)


    return (
        <TransactionContext.Provider value={{
            transactions: transactions, // Direct transactions as they are already filtered from server
